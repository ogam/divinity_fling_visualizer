...
set GAME_NAME=divinity_fling_visualizer.exe
...
set MINICORO_INCLUDE=libs\minicoro
set RAYLIB_GUI_INCLUDE=libs\raygui
set RAYLIB_IMGUI_INCLUDE=libs\rlImGui
...
set "MINICORO_INCLUDE=!ROOT_DIR!\!MINICORO_INCLUDE!"
set "RAYLIB_IMGUI_INCLUDE=!ROOT_DIR!\!RAYLIB_IMGUI_INCLUDE!"
...
IF DEFINED BUILD_DEBUG (
  ...
  set LINK_FLAGS=/link kernel32.lib user32.lib shell32.lib winmm.lib gdi32.lib opengl32.lib version.lib
...
IF NOT EXIST !TEMP_DIR!\ (
  ...
  set RAYLIB_C_FILES="!RAYLIB_SRC!\rcore.c" "!RAYLIB_SRC!\rshapes.c" "!RAYLIB_SRC!\rtextures.c" "!RAYLIB_SRC!\rtext.c" "!RAYLIB_SRC!\rmodels.c" "!RAYLIB_SRC!\utils.c" "!RAYLIB_SRC!\raudio.c" "!RAYLIB_SRC!\rglfw.c" "!RAYLIB_IMGUI_INCLUDE!\*.cpp"
  set RAYLIB_INCLUDE_FLAGS=/I"!RAYLIB_SRC!" /I"!RAYLIB_SRC!\external\glfw\include" /I"!MINICORO_INCLUDE!" /I"!RAYLIB_IMGUI_INCLUDE!"
...
IF DEFINED REALLY_QUIET (
  cl.exe !VERBOSITY_FLAG! !COMPILATION_FLAGS! !WARNING_FLAGS! /c /I"!RAYLIB_SRC!" /I"!MINICORO_INCLUDE!"  /I"!RAYLIB_IMGUI_INCLUDE!" !SOURCES! > NUL 2>&1 || exit /B
  cl.exe !VERBOSITY_FLAG! !OUTPUT_FLAG! "!ROOT_DIR!\!TEMP_DIR!\*.obj" *.obj !LINK_FLAGS! !SUBSYSTEM_FLAGS! > NUL 2>&1 || exit /B
) ELSE (
  cl.exe !VERBOSITY_FLAG! !COMPILATION_FLAGS! !WARNING_FLAGS! /c /I"!RAYLIB_SRC!" /I"!MINICORO_INCLUDE!"  /I"!RAYLIB_IMGUI_INCLUDE!" !SOURCES! || exit /B
